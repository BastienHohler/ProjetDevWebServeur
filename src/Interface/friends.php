  ...
  <div class="row">
    <div class="col border">
      ...
      <div class="row border">
        <div class="col">
          <p class="friends">{{friend.prenom}} {{friend.nom}}</p>
        </div>
        <div class="col">
          <p class="delFriends"><a href="/deleteFriend/{{friend.id_friend}}"><i class="fas fa-trash-alt"></i></a></p>
        </div>
      </div>
      {% endfor %}
    </div>
    <div class="col border">
      ...
      <div class="row border">
        <div class="col">
          <p class="pending">{{friendPending.prenom}} {{friendPending.nom}}</p>
        </div>
        <div class="col">
          <p class="delPending"><a href="/deleteFriend/{{friendPending.id_friend}}"><i class="fas fa-trash-alt"></i></a></p>
        </div>
      </div>
      {% endfor %}
    </div>
    <div class="col border">
      ...
      <div class="row border">
        <div class="col">
          <p class="applicant">{{friendRequest.prenom}} {{friendRequest.nom}}</p>
        </div>
        <div class="col">
          <div class="row">
            <div class="col">
